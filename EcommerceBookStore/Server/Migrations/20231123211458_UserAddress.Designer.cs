...
namespace EcommerceBookStore.Server.Migrations
{
    ...
    [Migration("20231123211458_UserAddress")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.CartItem", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.Product", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.ProductVariant", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.Address", b =>
                {
                    b.HasOne("EcommerceBookStore.Shared.User", null)
                        .WithOne("Address")
                        .HasForeignKey("EcommerceBookStore.Shared.Address", "UserId")
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.OrderItem", b =>
                {
                    b.HasOne("EcommerceBookStore.Shared.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EcommerceBookStore.Shared.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EcommerceBookStore.Shared.ProductType", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("EcommerceBookStore.Shared.Product", b =>
                {
                    b.HasOne("EcommerceBookStore.Shared.Category", "Category")
                        .WithMany()
