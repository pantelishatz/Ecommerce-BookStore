namespace EcommerceBookStore.Server.Services.ProductService
{
    public class ProductService : IProductService
    {
        ...
        /// <summary>
        /// Searches for products based on the provided search text and returns a list of matching products.
        /// </summary>
        /// <param name="searchText">The text to search for within product titles and descriptions.</param>
        /// <returns>A service response containing a list of matching products.</returns>
